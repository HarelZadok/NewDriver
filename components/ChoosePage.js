...
export default function ChoosePage({navigation}) {
    return <View style={styles.container}>
        ...
        <View style={styles.body}>
            <TouchableOpacity style={[styles.button, {marginTop: 50}]} onPress={() => moveToRegisterPage(navigation)}>
                <Text style={{fontWeight: 'bold', fontSize: 20, color: '#183658'}}>המשך בתור נהג חדש</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={() => moveToRegisterPage(navigation)}>
...
const moveToRegisterPage = (navigation) => {
